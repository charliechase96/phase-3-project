    ...
    while True:
        ...
        if choice == '1':  # Create Owner
            ...
            if owners:
                print("Owners:")
                for owner in owners:
                    print(f"{owner.id}.) Name: {owner.name}")
                
                owner_id_input = input("Enter owner list number to see pet information (or type 'back' to return to main menu): ")
                ...
                try:
                    ...
                    if owner:
                        ...
                        if pets:
                            ...
                            pet_id_input = input("Enter pet list number to see vaccine information (or type 'back' to return to main menu): ")
