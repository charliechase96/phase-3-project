            ...
            if owners:
                ...
                while True:
                    ...
                    if choice_pet_menu == '1':  # Create New Pet
                        ...
                        pet_id_input = input("Enter pet list number to see vaccine information (or type 'back' to return to Pet Menu): ")
                                    ...
                                    while True:
                                        ...
                                        if choice_vaccine_menu == '1':  # Add New Vaccine
                                            ...
                                            try:
                                                ...
                                                print(f"Vaccine '{vaccine.vaccine_type}' added successfully for {pet.name}")
                                            except ValueError as e:
                                                print(f"Error: {e}")
                                        ...
                                        elif choice_vaccine_menu == '3':  # Back to Pet Menu
                                            print("Returning to Pet Menu...")
                                            break
